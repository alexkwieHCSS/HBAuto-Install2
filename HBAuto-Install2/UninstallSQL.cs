...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("5ecc28e7-749e-4b4c-bc42-bb73720fb99f", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Wait", "(Optional Action)\r\nWaiting 10s to exist. Associated repository item: 'ProgramsAndFeatures.UninstallButton'", repo.ProgramsAndFeatures.UninstallButtonInfo, new ActionTimeout(10000), new RecordItemIndex(6));
                repo.ProgramsAndFeatures.UninstallButtonInfo.WaitForExists(10000);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(6)); }
            
            try {
                Report.Log(ReportLevel.Info, "Mouse", "(Optional Action)\r\nMouse Left Click item 'ProgramsAndFeatures.UninstallButton' at Center.", repo.ProgramsAndFeatures.UninstallButtonInfo, new RecordItemIndex(7));
                repo.ProgramsAndFeatures.UninstallButton.Click();
                Delay.Milliseconds(200);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(7)); }
            
            try {
                Report.Log(ReportLevel.Info, "Wait", "(Optional Action)\r\nWaiting 10s to exist. Associated repository item: 'ProgramsAndFeatures.YesButton'", repo.ProgramsAndFeatures.YesButtonInfo, new ActionTimeout(10000), new RecordItemIndex(8));
                repo.ProgramsAndFeatures.YesButtonInfo.WaitForExists(10000);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(8)); }
            
            try {
                Report.Log(ReportLevel.Info, "Mouse", "(Optional Action)\r\nMouse Left Click item 'ProgramsAndFeatures.YesButton' at Center.", repo.ProgramsAndFeatures.YesButtonInfo, new RecordItemIndex(9));
